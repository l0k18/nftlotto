...
func (*Ticket) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cf507d720f390ab, []int{0}
}
...
func (m *Ticket) GetLottery() uint64 {
	if m != nil {
		return m.Lottery
	}
	return 0
...
func init() {
	proto.RegisterType((*Ticket)(nil), "l0k18.nftlotto.nftlotto.Ticket")
}

func init() { proto.RegisterFile("nftlotto/ticket.proto", fileDescriptor_2cf507d720f390ab) }

var fileDescriptor_2cf507d720f390ab = []byte{
	// 173 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Ticket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Lottery != 0 {
		i = encodeVarintTicket(dAtA, i, uint64(m.Lottery))
		i--
		dAtA[i] = 0x10
	}
	if m.Id != 0 {
...
func (m *Ticket) Size() (n int) {
	...
	if m.Lottery != 0 {
		n += 1 + sovTicket(uint64(m.Lottery))
	}
	l = len(m.Creator)
	if l > 0 {
