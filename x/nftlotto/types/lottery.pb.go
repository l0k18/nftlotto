...
func (*Lottery) Descriptor() ([]byte, []int) {
	return fileDescriptor_063c712f2333f1d9, []int{0}
}
...
func (m *Lottery) GetTicketPrice() uint64 {
	if m != nil {
...
func (m *Lottery) GetDrawHeight() uint64 {
	if m != nil {
		return m.DrawHeight
	}
	return 0
...
func init() {
	proto.RegisterType((*Lottery)(nil), "l0k18.nftlotto.nftlotto.Lottery")
}

func init() { proto.RegisterFile("nftlotto/lottery.proto", fileDescriptor_063c712f2333f1d9) }

var fileDescriptor_063c712f2333f1d9 = []byte{
	// 215 bytes of a gzipped FileDescriptorProto
	,
	...
	0x69, 0x92, 0x5e, 0x72, 0x7e, 0xae, 0x3e, 0xd8, 0x27, 0xfa, 0x70, 0x7f, 0x56, 0x20, 0x98, 0x25,
	0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0x60, 0x1f, 0x1b, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x10,
	0x1d, 0x78, 0x39, 0x0b, 0x01, 0x00, 0x00,
}
...
func (m *Lottery) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DrawHeight != 0 {
		i = encodeVarintLottery(dAtA, i, uint64(m.DrawHeight))
		i--
		dAtA[i] = 0x20
	}
	if m.TicketPrice != 0 {
		i = encodeVarintLottery(dAtA, i, uint64(m.TicketPrice))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintLottery(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0x12
	}
	if m.Id != 0 {
...
func (m *Lottery) Size() (n int) {
	...
	if m.TicketPrice != 0 {
		n += 1 + sovLottery(uint64(m.TicketPrice))
	}
	if m.DrawHeight != 0 {
		n += 1 + sovLottery(uint64(m.DrawHeight))
	}
	l = len(m.Creator)
	if l > 0 {
		n += 1 + l + sovLottery(uint64(l))
