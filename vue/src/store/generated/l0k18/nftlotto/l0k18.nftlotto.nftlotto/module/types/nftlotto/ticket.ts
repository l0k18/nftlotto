...
const baseTicket: object = { id: 0, lottery: 0, creator: "" };

export const Ticket = {
  encode(message: Ticket, writer: Writer = Writer.create()): Writer {
    if (message.id !== 0) {
  ...
  decode(input: Reader | Uint8Array, length?: number): Ticket {
